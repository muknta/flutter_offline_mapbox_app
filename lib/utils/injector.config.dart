...
import 'package:flutter_offline_mapbox/data/db/sqlite_client.dart' as _i623;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    await gh.lazySingletonAsync<_i623.SqliteClient>(
      () {
        final i = _i623.SqliteClient();
    ...
    gh.factory<_i174.CommentResourcesDao>(
        () => _i174.CommentResourcesDao(gh<_i623.SqliteClient>()));
    gh.factory<_i456.PointsDao>(
        () => _i456.PointsDao(gh<_i623.SqliteClient>()));
    gh.factory<_i14.UsersDao>(() => _i14.UsersDao(gh<_i623.SqliteClient>()));
    gh.factory<_i713.CommentsDao>(
        () => _i713.CommentsDao(gh<_i623.SqliteClient>()));
    return this;
  }
}
